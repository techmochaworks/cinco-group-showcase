    ...
    <section className="bg-sand py-24">
      <div className="mx-auto grid max-w-7xl items-center gap-14 px-5 lg:grid-cols-2">
        <div>
          ...
          <a
            href="#contact"
            className="mt-10 inline-flex rounded-sm bg-primary px-7 py-3.5 text-sm font-bold text-primary-foreground transition-opacity hover:opacity-90"
          >
            Contact Us Now
          </a>
        </div>
        ...
        <div className="relative">
          <img
            ...
            loading="lazy"
            className="h-[520px] w-full rounded-sm object-cover shadow-lift"
          />
          <div className="absolute -bottom-6 -left-6 hidden rounded-sm surface-deep px-7 py-5 shadow-lift md:block">
